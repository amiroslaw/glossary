...
export class GLUserDeleteDialogComponent {
    ...
    constructor(private gLUserService: GLUserService, public activeModal: NgbActiveModal, private eventManager: JhiEventManager) {}
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ gLUser }) => {
            setTimeout(() => {
                ...
                this.ngbModalRef.componentInstance.gLUser = gLUser;
