...
import ovh.miroslaw.config.audit.AuditEventConverter;
import ovh.miroslaw.domain.PersistentAuditEvent;
...
import static ovh.miroslaw.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
