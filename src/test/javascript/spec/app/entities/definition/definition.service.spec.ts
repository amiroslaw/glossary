...
describe('Service Tests', () => {
    describe('Definition Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DefinitionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/definitions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Definition', () => {
                service.create(new Definition(null)).subscribe(received => {
            ...
            it('should update a Definition', () => {
                service.update(new Definition(123)).subscribe(received => {
            ...
            it('should return a list of Definition', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Definition(123)]);
            });
