    ...
    describe('Dictionary Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/dictionaries';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Dictionary', () => {
                service.create(new Dictionary(null)).subscribe(received => {
            ...
            it('should update a Dictionary', () => {
                service.update(new Dictionary(123)).subscribe(received => {
